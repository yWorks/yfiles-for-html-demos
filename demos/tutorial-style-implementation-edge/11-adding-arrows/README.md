...
In [createVisual](https://docs.yworks.com/yfileshtml/api/EdgeStyleBase#createVisual), we add the arrows to our visualization using the [addArrows](https://docs.yworks.com/yfileshtml/api/EdgeStyleBase#addArrows) method from the base class [EdgeStyleBase](https://docs.yworks.com/yfileshtml/api/EdgeStyleBase). For this purpose, we create an own SVG group `arrows`. The [addArrows](https://docs.yworks.com/yfileshtml/api/EdgeStyleBase#addArrows) method adds the arrows to this group. Finally, this group is added to the group with the other edge visualization elements.
...
Additionally, we need to update the visualization of arrows in the [updateVisual](https://docs.yworks.com/yfileshtml/api/EdgeStyleBase#updateVisual) method with the [updateArrows](https://docs.yworks.com/yfileshtml/api/EdgeStyleBase#updateArrows) method, if the arrows or edge path have changed since the last call.
