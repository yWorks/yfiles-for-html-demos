...
See the steps about [Adjacency Graph Builder](../../tutorial-graph-builder/12-adjacency-graph-builder/) and [Tree Builder](../../tutorial-graph-builder/13-tree-builder/) of this tutorial for an explanation on how these classes work.
