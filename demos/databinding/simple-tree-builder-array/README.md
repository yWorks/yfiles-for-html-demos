...
[You can also run this demo online](https://www.yfiles.com/demos/databinding/simple-tree-builder-array/).

This demo automatically builds a graph from business data using [TreeBuilder](https://docs.yworks.com/yfileshtml/#/api/TreeBuilder). The business data is stored in an Array in **JSON** format.
